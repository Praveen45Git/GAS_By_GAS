          ...
          <Col sm={5}>
            <Form>
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col sm={9}>
                  <Form.Control type="text" placeholder="Enter Customer Name" value={customerId} onChange={(e) => setCustomerName(e.target.value)} />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col sm={9}>
                  <Form.Control as="select" value={outlet} onChange={(e) => setOutlet(e.target.value)}>
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col sm={9}>
                  <Form.Control type="number" placeholder="Count" value={emptyGasCount} onChange={(e) => setEmptyGasCount(Math.max(0, parseInt(e.target.value) || 0))} />
                </Col>
              </Form.Group>
